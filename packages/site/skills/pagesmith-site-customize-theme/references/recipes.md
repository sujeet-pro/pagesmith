...
For first-time setup or retrofit work, start with `node_modules/@pagesmith/site/skills/pagesmith-site-setup/references/setup-site.md` before applying these targeted recipes.
