...
import { getExtensionMap, getMatchedExtension, type DiagramType } from 'diagramkit'

const DEFAULT_DIAGRAMS_DIR = '.diagrams'
...
export function rehypeDiagramImages(options: RehypeDiagramImagesOptions = {}) {
  ...
  const outputDir = options.outputDir ?? DEFAULT_DIAGRAMS_DIR
