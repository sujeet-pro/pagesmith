...
This file is for first-time setup and retrofit work. For upgrades to an existing `@pagesmith/core` integration, use `node_modules/@pagesmith/core/ai-guidelines/migration.md`.
...
```text
Set up `@pagesmith/core` in this repository. Read `node_modules/@pagesmith/core/ai-guidelines/setup-core.md` first and follow it exactly.
...
```text
Improve the existing `@pagesmith/core` integration in this repository. Read `node_modules/@pagesmith/core/ai-guidelines/setup-core.md` first and then make the current setup more agent-friendly without changing the project’s architecture unnecessarily.
