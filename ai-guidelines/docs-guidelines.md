...
- Root docs site: `pagesmith.config.json5`, `docs-site/content/**`
- Example docs site: `examples/doc-site/**`

## Maintainer Rules

- In this repo, the docs-site config lives at the repo root in `pagesmith.config.json5`.
- The root docs-site content for this repo lives in `docs-site/content/`.
...
7. Root docs pages under `docs-site/content/`
8. `examples/doc-site/`
...
10. Tests under `packages/docs/src/__tests__/`, `tests/integration/`, and `tests/e2e/` (Playwright)
