...
If you already follow the default conventions, the config file is optional: `pagesmith dev`, `build`, `preview`, and `mcp` can run directly from a repo-root `docs/` folder and emit to `gh-pages/`.
