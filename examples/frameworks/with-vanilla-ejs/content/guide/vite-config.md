...
Unlike the React or Solid examples, this config does not include `pagesmithContent`. The EJS example uses `createContentLayer` directly in the SSR entry instead of relying on virtual modules. This means:
