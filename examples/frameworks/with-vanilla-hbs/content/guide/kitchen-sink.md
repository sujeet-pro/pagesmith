...
This is the single markdown regression page for the Handlebars example. It gives you one obvious place to verify alerts, math, GFM, code block chrome, and prose styling in the rendered output.
