...
Handlebars-based static site using `@pagesmith/core` for collections and markdown, plus `@pagesmith/site` for Vite SSG, shared assets, and the shipped content runtime. It keeps templating on Handlebars instead of moving to a framework component model.

## AI-First Starting Point

To recreate this shape in another repository, install `@pagesmith/core`, `@pagesmith/site`, `handlebars`, and your Vite tooling, then start with `node_modules/@pagesmith/site/ai-guidelines/setup-site.md`.
