...
Pagesmith wires the example into the Vite+ static-site pipeline. During development, editing a markdown file triggers HMR. At build time, the content layer feeds rendered HTML into the Handlebars templates.
