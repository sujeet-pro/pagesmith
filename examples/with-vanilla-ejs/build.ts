 ...
 *
 * Demonstrates using pagesmith with plain EJS templates
...
const distDir = resolve(__dirname, '../../gh-pages/examples/vanilla-ejs')
const templatesDir = resolve(__dirname, 'templates')
const basePath = '/pagesmith/examples/vanilla-ejs/'
