...
To recreate this shape in another repository, install `@pagesmith/site` and `solid-js`, then start with `node_modules/@pagesmith/site/ai-guidelines/setup-site.md` for the content model, Vite wiring, and SSG flow.
