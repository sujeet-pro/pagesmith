...
Solid-based static site using `@pagesmith/core` for collections and markdown, plus `@pagesmith/site` for Vite SSG, shared assets, and the shipped content runtime.

## AI-First Starting Point

To recreate this shape in another repository, install `@pagesmith/core`, `@pagesmith/site`, and `solid-js`, then start with `node_modules/@pagesmith/site/ai-guidelines/setup-site.md`.
