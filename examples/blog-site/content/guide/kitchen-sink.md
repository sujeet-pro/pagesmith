...
This is the single markdown regression page for the built-in JSX runtime example. It gives you one obvious place to verify alerts, math, GFM, code block chrome, and prose styling in the rendered output.

For how this example is wired, use the rest of the guide: content layer setup, routing, rendering, and the Pagesmith JSX runtime are documented there.
