---
name: sync-package-ai-guidelines
description: Update published package ai-guidelines, schemas, and installer references after public Pagesmith behavior changes. Use when package APIs, markdown behavior, docs workflow, or hosting behavior changes.
---
# Sync Package AI Guidelines
...
4. Update `packages/core/src/ai/**` so generated assistant files reference the new package guidance correctly.
5. Verify the installed-package paths under `node_modules/@pagesmith/*/...` would be valid after publish.
...
- Keep the docs package setup prompt, docs guidelines, markdown guidelines, and schemas aligned.
