...
> [!NOTE]
> These design tokens are for `@pagesmith/site`'s shared CSS bundles. The default `@pagesmith/docs` theme composes these bundles and layers docs-specific layout/home/not-found styling on top. See the [Docs Theme reference](../docs-theme/README.md) for the preset's ownership split and override points.
