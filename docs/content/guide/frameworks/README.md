...
| ---------------------------------------------------------------- | ----------------- | -------------------- | ------------------------------------------- | -------------------------------------------------------------------------------------------- |
| [React](../framework-vite-apps/README.md#react)                  | `@pagesmith/site` | `react-dom/server`   | `virtual:content/*`                         | <a href="/pagesmith/examples/react" target="_blank" rel="noopener noreferrer">Live</a>       |
| [Solid](../framework-vite-apps/README.md#solidjs)                | `@pagesmith/site` | `solid-js/web`       | `virtual:content/*`                         | <a href="/pagesmith/examples/solid" target="_blank" rel="noopener noreferrer">Live</a>       |
| [Svelte](../framework-vite-apps/README.md#svelte)                | `@pagesmith/site` | `svelte/server`      | `virtual:content/*`                         | <a href="/pagesmith/examples/svelte" target="_blank" rel="noopener noreferrer">Live</a>      |
| [Next.js](../framework-nextjs/README.md)                         | `@pagesmith/site` | Next.js App Router   | `createContentLayer`                        | <a href="/pagesmith/examples/nextjs" target="_blank" rel="noopener noreferrer">Live</a>      |
| [EJS](../framework-template-engines/README.md#ejs)               | `@pagesmith/site` | EJS templates        | `createContentLayer`                        | <a href="/pagesmith/examples/vanilla-ejs" target="_blank" rel="noopener noreferrer">Live</a> |
| [Handlebars](../framework-template-engines/README.md#handlebars) | `@pagesmith/site` | Handlebars templates | `createContentLayer`                        | <a href="/pagesmith/examples/vanilla-hbs" target="_blank" rel="noopener noreferrer">Live</a> |
| [Doc Site](../framework-doc-site/README.md)                      | `@pagesmith/docs` | Docs theme           | Convention-based                            | <a href="/pagesmith/examples/doc-site" target="_blank" rel="noopener noreferrer">Live</a>    |
| [Blog Site](../framework-blog-site/README.md)                    | `@pagesmith/site` | Custom JSX layouts   | Filesystem + site re-exported content layer | <a href="/pagesmith/examples/blog-site" target="_blank" rel="noopener noreferrer">Live</a>   |
...
For full details, see the [Theming reference](../../reference/theming/README.md).
...
| If you want...                                                              | Choose...                                                   |
| --------------------------------------------------------------------------- | ----------------------------------------------------------- |
| A documentation site that works from configuration alone                    | [Doc Site](../framework-doc-site/README.md)                 |
| Full layout control with a specific framework (React, Solid, Svelte)        | [Vite Framework Apps](../framework-vite-apps/README.md)     |
| An existing Next.js app that should keep its own router, layouts, and build | [Next.js (App Router)](../framework-nextjs/README.md)       |
| No framework runtime, simple templates                                      | [Template Engines](../framework-template-engines/README.md) |
| A fully custom site with its own design system                              | [Blog Site](../framework-blog-site/README.md)               |

## Read Next

- [Vite Framework Apps](../framework-vite-apps/README.md) -- React, SolidJS, Svelte
- [Next.js (App Router)](../framework-nextjs/README.md) -- `createContentLayer()` inside a Next.js app
- [Template Engines](../framework-template-engines/README.md) -- EJS, Handlebars
- [Doc Site](../framework-doc-site/README.md)
- [Blog Site](../framework-blog-site/README.md)
