...
- [Getting Started](../getting-started/README.md) — collections, schemas, and `createContentLayer()`
- [Runtime](../../reference/runtime/README.md) — `@pagesmith/site/css/*` and `@pagesmith/site/runtime/*`
- [Framework Integrations](../frameworks/README.md) — compare Vite, template-engine, docs, and Next.js patterns
