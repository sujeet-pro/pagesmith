...
If the project also needs the shared Pagesmith site layer, tell the agent to read `node_modules/@pagesmith/site/skills/pagesmith-site-setup/references/setup-site.md` too. If you want the convention-based docs workflow instead, use [Docs Getting Started](../docs-getting-started/README.md).
...
If you want a convention-based docs site with built-in navigation and search, see the [Docs Getting Started](../docs-getting-started/README.md) guide instead.
...
See [Next.js (App Router)](../framework-nextjs/README.md) for a complete example of this pattern.
...
> Looking to build a documentation site? See the [Docs Getting Started](../docs-getting-started/README.md) guide for a complete walkthrough of `@pagesmith/docs`, including config, content structure, navigation, search, and deployment.
...
- [Collections and Loaders](../collections-and-loaders/README.md) -- defining collections, built-in loaders, custom loaders, schemas
- [Validation and Rendering](../validation-and-rendering/README.md) -- schema validation, content validators, the markdown pipeline
- [Next.js (App Router)](../framework-nextjs/README.md) -- direct `createContentLayer()` + `entry.render()` inside a framework app
- [API Reference](../../reference/api/README.md) -- full API surface of `@pagesmith/core`, `@pagesmith/site`, and `@pagesmith/docs`
- [Configuration Reference](../../reference/configuration/README.md) -- all configuration options
- [AI Assistants](../ai-assistants/README.md) -- installing assistant memory and skill files
