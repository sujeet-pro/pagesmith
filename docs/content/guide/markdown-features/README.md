...
- [Alerts & Callouts](../alerts-and-callouts/README.md) - GitHub-style callouts, multi-paragraph notes, lists, and code blocks inside alerts
- [GFM Extensions](../gfm-extensions/README.md) - tables, task lists, strikethrough, autolinks, and footnotes
- [Typography](../typography/README.md) - headings, links, images, blockquotes, lists, and smart punctuation
- [Math & LaTeX](../math-and-latex/README.md) - inline and display equations rendered with MathJax
- [Code Blocks](../code-blocks/README.md) - titles, line numbers, highlighting, diff markers, collapse, and tabs
...
- The `.invert.` filename convention and light/dark pair handling are core features (see the [Markdown Reference](../../reference/markdown-reference/README.md)); the docs asset pass only handles URL rewriting to published paths.
...
For validation details and lifecycle notes, see [Validation & Rendering](../validation-and-rendering/README.md).
